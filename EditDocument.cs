...
namespace QuanlyKho1
{
    public partial class EditDocument : Form
    {
        ...
        private void EditDocument_Load(object sender, EventArgs e)
        {
            ...
            comboBoxPerson.DisplayMember = "NamePerson";
            comboBoxPerson.ValueMember = "PersonID";
            comboBoxPerson.DataSource = db.Persons.Select(i => new { NamePerson = i.NamePerson, PersonID = i.PersonID }).ToList();
            ...
            cbUser.DisplayMember = "NameUser";
            cbUser.ValueMember = "UserID";
            cbUser.DataSource = db.Users.Select(i => new { NameUser = i.NameUser, UserID = i.UserID }).ToList();
